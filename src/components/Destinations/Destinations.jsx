...
const Destinations = () => {
  return (
    <section>
    <div className='wrapper lg:py-[5rem] py-[2rem] lg:px-12 px-2 flex flex-col items-center justify-center gap-6'>
      ...
      <div className='grid grid-cols-2  md:grid-cols-3 lg:grid-cols-4 items-center justify-center gap-8 gap-y-8'>
