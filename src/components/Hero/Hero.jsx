      ...
      <div className="wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-between gap-20 py-[2rem] lg:py-[5rem] px-2 lg:px-12 items-center">
        ...
        <div className="order-1 md:order-2 lg:order-2 sm:order-1">
          <div className="relative w-full max-w-[500px] mx-auto">
            ...
            {/* Flight badge */}
            <div className="absolute top-[20%] left-[70%] md:left-[70%] bg-gray-50 flex items-center justify-center gap-1 py-1 px-2 rounded-full w-auto">
              <img
                className="w-4 h-4"
                src="/images/ic_baseline-flight.png"
                alt="flight"
              />
              <p className="text-[11px] md:text-[13px]">Jakarta</p>
            </div>
          </div>
        </div>
      </div>
