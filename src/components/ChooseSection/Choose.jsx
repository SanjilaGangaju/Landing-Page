    ...
    <section>
      <div className='wrapper py-[2rem] lg:py-[5rem] lg:px-12 grid grid-cols-1 px-2  md:grid-cols-2 gap-10'>
        ...
        <div className='flex flex-col gap-10'>
          ...
          <p className='text-md text-center lg:text-2xl md:w-[25rem] lg:w-[39rem]'>Enjoy different experiences in every place you visit and discover new and affordable adventures of course.</p>
          </div>
